<template>
	...
	-webkit-box-shadow: 0 3px 3px rgba(0,0,0,0.2);">
                        ...
                        <hr style="background: #d3dc82;margin-top: 20px; "><br>
                        <input type="button"  value="Edit" class="set_button" @click="settings">
                        <div>{{'Went:'+ went}}</div>
                        <div style=" margin-top: 20px;">{{'Lived:'+lived}}</div>
                        <div style=" margin-top: 20px;">{{'From:'+from}}</div>
                        <hr style="background: #76ae0a;margin-top: 20px; "><br>
                        <div class="span">
	...
	-webkit-box-shadow: 0 3px 3px rgba(0,0,0,0.2);">
                        ...
                        <button type="text" class="submit-btn" style="background: #304607; margin-left: 0px; height: 35px;
        min-width: 100px;
