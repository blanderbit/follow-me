<template>
    <div id="chat_message">
        ...
        <div style="overflow-y: scroll; overflow-x:hidden;  height: 390px;" @click="scroll" class="scroll">
        ...
        <div class="sendMassege">
            <textarea class="send" v-model="quotes" :style="{height: textereaHeight}" @keyup="change" style="float: left" placeholder="Write text"></textarea><ion-icon name="arrow-forward"  style="float: right; font-size: 40px" class="pointer" @click="sendToChat"></ion-icon>
            <div class="clear"></div>
        </div>
    </div>
</template>
