        ...
        <form name="registration-form"  style="margin-top: 20px;margin-bottom: 20px;"  class="registration-form" method="post">
            ...
            <div  class="content " >
                ...
                <div class="regFloatRight" >
                    ...
                    <label >Enter your name</label><span class="required">*</span><br><br>
                    <input name="firstname" type="text" id='first'  class="input firstname" placeholder="Name"/><br><br>
                    <label>Enter your lastname</label><span class="required">*</span><br><br>
                    <input name="lastname" type="text" id='last' class="input lastname" placeholder="Lastname"/><br><br><hr style="margin-top:10px;margin-bottom: 10px;background: blue"><captch></captch><br><br>
                </div>
    ...
    export default {
        ...
        data:function(){
              return{
                  ...
                  error4:'',
                  error5:'',
                  user_noemptys:false,user_empty:false,
                  passw_noemptys:false,passw_empty:false,
                  mail_noemptys: false,mail_empty:false,
                  passw_con:'',
        ...
        methods: {
            submitForm:function() {
                    if( this.user && (this.user.length >= 6)&& this.passw && (this.passw.length >= 6)&& this.mail && (this.passw_con == this.passw) && (this.result == this.capch)){
                        axios
                ...
                if(!this.user){ this.error1 ="Login required."}else{this.error1 =""}
                if(!this.passw) {this.error2 ="password required."}else{this.error2 =""}
                if(!this.mail) {this.error3 ="Email required."}else{this.error3 =""}
                if(this.user.length <6){ this.error4 ="Nick must have 6 simvols"}else{this.error4 =""}
                if(this.passw.length <6) {this.error5 = "Password must have 6 simvols"}else{this.error5 =""}
            },
