...
<script>
    ...
    import navBar from '../profil/navbarProfil.vue'
    import profPhoto from './prof-photo-friends.vue'
    import axios from 'axios'
    import settings from '../profil/settings.vue'
    import AddPost from '../profil/addPost.vue'
    import showPost from '../profil/showPost.vue'
    import Vue from 'vue'
    function validToken(){
        ...
        created:function(){
            ...
            axios({
                ...
                .then(response => {
                    ...
                    this.firstName =response.data.profile.firstname;localStorage.setItem('firstName',response.data.profile.firstname)
                    this.lastName =response.data.profile.lastname;localStorage.setItem('lastName',response.data.profile.lastname)
                    this.friends = response.data.friends_count;
                    this.enemies = response.data.enemies_count;
                    this.quotes =response.data.profile.quote;localStorage.setItem('quotes',response.data.profile.quote)
                    this.from =response.data.profile.from;localStorage.setItem('from',response.data.profile.from)
                    this.lived =response.data.profile.lived;localStorage.setItem('lived',response.data.profile.lived)
                    this.went =response.data.profile.went;localStorage.setItem('went',response.data.profile.went)
                    this.photo =response.data.profile.photo;localStorage.setItem('photo',response.data.profile.photo)
                    console.log(validToken())
